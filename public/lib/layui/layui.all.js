...
layui.define("jquery", function (i) {
    ...
    s.prototype.set = function (i) {
        ...
        var e = ".layui-tab-title", l = t(".layui-tab[lay-filter=" + i + "]"), n = l.children(e), s = n.children(".layui-tab-bar"), o = l.children(".layui-tab-content"), c = '<li lay-id="' + (a.id || "") + '">' + (a.title || "unnaming") + "</li>";
        ...
        var e = ".layui-tab-title", l = t(".layui-tab[lay-filter=" + i + "]"), n = l.children(e), s = n.find('>li[lay-id="' + a + '"]');
        ...
        var e = "layui-progress", l = t("." + e + "[lay-filter=" + i + "]"), n = l.find("." + e + "-bar"), s = n.find("." + e + "-text");
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child", h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
        tabClick: function (i, a, s, o) {
            o = o || {};
            var c = s || t(this), a = a || c.parent().children("li").index(c), r = o.headerElem ? c.parent() : c.parents(".layui-tab").eq(0), u = o.bodyElem ? t(o.bodyElem) : r.children(".layui-tab-content").children(".layui-tab-item"), d = c.find("a"), h = r.attr("lay-filter");
            ...
            var n = a || t(this).parent(), s = n.index(), o = n.parents(".layui-tab").eq(0), c = o.children(".layui-tab-content").children(".layui-tab-item"), r = o.attr("lay-filter");
            ...
            var i = t(this), a = i.parents(o), n = a.attr("lay-filter"), s = i.find("a"), c = "string" == typeof i.attr("lay-unselect");
            ...
            var i = t(this), a = i.find(".layui-colla-icon"), l = i.siblings(".layui-colla-content"), s = i.parents(".layui-collapse").eq(0), o = s.attr("lay-filter"), c = "none" === l.css("display");
        ...
        var l = function () {
            ...
            tab: function () {
                ...
                t("." + i + l).each(function () {
                    ...
                    i.each(function () {
                        var i = t(this), a = i.find(".layui-colla-title"), e = i.find(".layui-colla-content"), l = "none" === e.css("display");
